...
public class CollectionControllerImpl extends AbsSuperController implements ICollectionController {
    ...
    public String delCollection(@PathVariable("id") Long id) throws IOException {
        collection.setId(id);
    ...
    public String batchDelColl(@RequestBody List<Long> ids) throws IOException {
    ...
    public String findUserCollection(@PathVariable("userCollectionId") Long userCollectionId) throws IOException {
    ...
    public String saveCollection(@RequestBody String collString) throws IOException {
