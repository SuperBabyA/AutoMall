...
public class DetailControllerImpl extends AbsSuperController implements IDetailController {
    ...
    public String deleteDetail(@PathVariable("id") Long id) throws IOException {
        detail.setId(id);
    ...
    public String findAllCarInfo(@PathVariable("id") Long id) throws IOException {
    ...
    public String saveDetail(@RequestBody String detailStr) throws IOException {
    ...
    public String editDetail(@RequestBody String detailStr) throws IOException {
        Detail detailObj = new ObjectMapper().readValue(detailStr, Detail.class);
        getBll().setModel(detailObj);
